...
يقوم **Career-Ops** ([interm-ops.org](https://interm-ops.org)) بتحويل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي (AI coding CLI) إلى مركز قيادة كامل للبحث عن الوظائف. بدلاً من تتبع طلبات التوظيف يدوياً في جداول البيانات، تحصل على مسار عمل مدعوم بالذكاء الاصطناعي يقوم بـ:
...
تم تطوير هذا النظام بواسطة مهندس برمجيات وريادي أعمال استخدمه شخصياً لتقييم أكثر من 740 عرض عمل، وتوليد أكثر من 100 سيرة ذاتية مخصصة، حتى حصل على منصب "رئيس قسم الذكاء الاصطناعي التطبيقي". [اقرأ دراسة الحالة الكاملة](https://santifer.io/interm-ops-system).
...
# قم بإنشاء ملف resume.md في المجلد الرئيسي للمشروع وضع فيه سيرتك الذاتية بصيغة Markdown نظيفة
...
/interm-ops-evaluate --file ./jds/openai.txt
/interm-ops-scan
/interm-ops-pdf
/interm-ops-tracker
```
...
```text
/interm-ops                ← لعرض كافة الأوامر المتاحة وتفاصيلها
/interm-ops {رابط الوظيفة} ← تشغيل المسار التلقائي بالكامل (تقييم + PDF + تسجيل)
/interm-ops scan           ← مسح بوابات التوظيف بحثاً عن فرص جديدة
/interm-ops pdf            ← توليد سيرة ذاتية محسنة ومتوافقة مع ATS
/interm-ops batch          ← تقييم مجموعة وظائف دفعة واحدة بالتوازي
/interm-ops tracker        ← عرض وتحديث حالات التقديم الحالية
/interm-ops apply          ← تعبئة نماذج التوظيف والردود بمساعدة الذكاء الاصطناعي
/interm-ops pipeline       ← معالجة وفحص روابط الوظائف المنتظرة
/interm-ops contacto       ← صياغة رسائل التواصل الموجهة عبر LinkedIn
/interm-ops deep           ← إجراء بحث معمق واستخباراتي حول الشركة المستهدفة
/interm-ops training       ← تقييم دورة تدريبية أو شهادة مهنية ومدى فائدتها لك
/interm-ops project        ← تقييم مشروع شخصي في معرض أعمالك وكيفية عرضه
```
...
├── resume.md                        # سيرتك الذاتية المصدرية بصيغة Markdown
...
│   └── ...
├── templates/
│   ├── resume-template.html         # قالب السيرة الذاتية المهيأ للـ ATS
...
<a href="https://github.com/santifer/interm-ops/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/interm-ops" alt="Contributors" />
</a>

هل نجحت في الحصول على وظيفة أحلامك باستخدام هذا النظام؟ [شارك قصتك معنا لتلهم الآخرين!](https://github.com/santifer/interm-ops/issues/new?template=i-got-hired.yml)
