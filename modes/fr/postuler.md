...
- **Nouvelle question** -> generer la reponse depuis le report + `resume.md`
...
5. **interm-ops proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/interm-ops contacto` pour du LinkedIn outreach vers le hiring manager
