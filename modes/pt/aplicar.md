...
- **Pergunta nova** → gerar resposta a partir do report + `resume.md`
...
5. **interm-ops proof point**: Incluir em "Informações adicionais" se houver campo para isso
...
3. Sugerir próximo passo: `/interm-ops contacto` para LinkedIn outreach
