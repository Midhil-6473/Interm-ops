# Contexto Compartilhado -- interm-ops (Português BR)
...
<!-- ============================================================
     ...
     that improve with each interm-ops release.
     ============================================================ -->
...
|---------|---------|--------|
| resume.md | `resume.md` (raiz do projeto) | SEMPRE |
...
**REGRA: NUNCA fazer hardcode de métricas de proof points.** Leia-as de `resume.md` e `article-digest.md` no momento da avaliação.
**REGRA: Para métricas de artigos/projetos, `article-digest.md` tem prioridade sobre `resume.md`** (`resume.md` pode conter números desatualizados).
...
> **Métricas concretas: ler de `resume.md` e `article-digest.md` no momento da avaliação. NUNCA fazer hardcode aqui.**

| Se a vaga é... | Enfatizar no candidato... | Fontes de Proof Points |
|----------------|--------------------------|------------------------|
| Platform / LLMOps | Experiência em produção, Observability, Evals, Closed-Loop | article-digest.md + resume.md |
| Agentic / Automation | Orquestração multi-agent, HITL, Confiabilidade, Custos | article-digest.md + resume.md |
| Technical AI PM | Product Discovery, PRDs, Métricas, Gestão de stakeholders | resume.md + article-digest.md |
| Solutions Architect | Design de sistemas, Integrações, Enterprise-ready | article-digest.md + resume.md |
| Forward Deployed Engineer | Entrega rápida, próximo do cliente, Protótipo a produção | resume.md + article-digest.md |
| AI Transformation Lead | Gestão de mudança, Enablement de equipe, Adoção | resume.md + article-digest.md |
...
2. Modificar `resume.md` ou arquivos do portfolio
...
1. Ler `resume.md`, `_profile.md` e `article-digest.md` (se existir) antes de avaliar qualquer vaga
1b. **Na primeira avaliação de cada sessão:** Executar `node resume-sync-check.mjs` via Bash. Se houver avisos, informar o candidato antes de continuar
