# interm-ops — Türkçe Modlar (`modes/tr/`)

Bu klasör, Türkiye iş piyasasında iş arayanlar veya Türkçe ilanlarla çalışanlar için interm-ops modlarının Türkçe çevirilerini içerir.
