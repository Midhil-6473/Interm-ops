# Ortak Bağlam -- interm-ops (Türkçe)
...
|-------|-------|----------|
| resume.md | `resume.md` (proje kök dizini) | Her zaman |
...
**KURAL: Kanıt noktalarındaki ölçüm değerlerini ASLA sabit kodlama.** Değerlendirme sırasında bunları resume.md + article-digest.md dosyalarından oku.
**KURAL: Makale/proje metrikleri için `article-digest.md`, `resume.md`'ye göre önceliklidir.**
...
> **Somut rakamlar ve metrikler: değerlendirme sırasında `resume.md` ve `article-digest.md` dosyalarından okunacak. Buraya sabit yazma.**


| Rol ise... | Adayda şunu öne çıkar... | Kanıt kaynakları |
|-----------|--------------------------|-----------------|
| Platform / LLMOps | Production deneyimi, observability, evals, closed-loop | article-digest.md + resume.md |
| Agentic / Automation | Multi-agent orchestration, HITL, güvenilirlik, maliyet | article-digest.md + resume.md |
| Technical AI PM | Product discovery, PRD'ler, metrikler, paydaş yönetimi | resume.md + article-digest.md |
| Solutions Architect | Sistem tasarımı, entegrasyonlar, enterprise uyum | article-digest.md + resume.md |
| Forward Deployed Engineer | Hızlı teslimat, müşteri yönlü, prototipten production'a | resume.md + article-digest.md |
| AI Transformation Lead | Değişim yönetimi, ekip enablement, benimseme | resume.md + article-digest.md |
...
2. `resume.md` ya da portfolyo dosyalarını değiştirme
...
1. Herhangi bir ilanı değerlendirmeden önce `resume.md` ve `article-digest.md` dosyalarını oku (varsa)
1b. **Her oturumun ilk değerlendirmesinde:** `node resume-sync-check.mjs` çalıştır. Uyarı varsa adayı bilgilendirmeden devam etme
