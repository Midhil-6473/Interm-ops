...
- **New question** → generate response from the report + resume.md
...
5. **interm-ops proof point**: Include in "Additional info" if there is a field for it
...
3. Suggest next step: `/interm-ops contacto` for LinkedIn outreach
