# Interm-Ops -- الأنماط واللغة العربية (`modes/ar/`)

يحتوي هذا المجلد على الترجمة العربية الكاملة للأنماط (modes) الأساسية لنظام interm-ops، والمصممة خصيصاً للمرشحين والمطورين في العالم العربي والشرق الأوسط، أو الذين يتقدمون لوظائف تتطلب التواصل باللغة العربية.
...
- `resume.md` و `pipeline` و `tracker` و `report` و `score` و `archetype` و `proof point`.
