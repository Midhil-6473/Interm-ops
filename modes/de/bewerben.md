...
5. **interm-ops Proof Point**: in "Zusätzliche Informationen" einbauen, falls ein solches Feld existiert
...
3. Nächsten Schritt vorschlagen: `/interm-ops contacto` für LinkedIn-Outreach an den Personalleiter / Hiring Manager
