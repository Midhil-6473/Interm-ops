# Geteilter Kontext -- interm-ops (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle interm-ops-Modi
     in der deutschen Variante. Bevor du interm-ops verwendest, MUSST du:
