# interm-ops Trademark Policy

This document explains how the "interm-ops" name and brand may be used.
...
"interm-ops," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  interm-ops," "based on interm-ops," "fork of interm-ops," "extends
  interm-ops" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  interm-ops as origin if you like.
...
- **Product, service, or company names** that include "interm-ops" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "interm-ops Cloud," "interm-ops Pro," "interm-ops SaaS," "Career-Ops
  Hosted," "CareerOps by [vendor]," "Cloud interm-ops," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by interm-ops," "Official interm-ops," "Sponsored by
  interm-ops," "Partner of interm-ops," "Featured by interm-ops," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "interm-ops" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("interm-ops Certified," "interm-ops Verified").
...
interm-ops is a community-built project used by tens of thousands of
...
© 2026 Santiago Fernández de Valderrama. "interm-ops"™ is a trademark of
