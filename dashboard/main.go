...
import (
	...
	"github.com/santifer/interm-ops/dashboard/internal/data"
	"github.com/santifer/interm-ops/dashboard/internal/model"
	"github.com/santifer/interm-ops/dashboard/internal/theme"
	"github.com/santifer/interm-ops/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to interm-ops directory")
	flag.Parse()
