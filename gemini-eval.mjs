#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for interm-ops
 *
 * A free-tier alternative to the Claude-based pipeline.
 * Reads evaluation logic from modes/oferta.md + modes/_shared.md,
 * reads the user's resume from resume.md, and evaluates a Job Description
...
const PATHS = {
  ...
  evaluate:    join(ROOT, '.claude', 'skills', 'interm-ops', 'SKILL.md'),
  cv:          join(ROOT, 'resume.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           interm-ops — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
const cvContent      = readFile(PATHS.cv,          'resume.md');
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are interm-ops, an AI-powered job search assistant.
