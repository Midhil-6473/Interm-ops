...
/**
 * resume-sync-check.mjs — Validates that the interm-ops setup is consistent.
 *
 * Checks:
 * 1. resume.md exists
...
if (!existsSync(cvPath)) {
  ...
  if (cvContent.trim().length < 100) {
    warnings.push('resume.md seems too short. Make sure it contains your full CV.');
  }
}
